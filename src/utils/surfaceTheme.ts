...
export const SURFACE_PRESETS: SurfacePreset[] = [
  ...
  },
  {
    ...
    accent: '#16A34A',
    swatch: ['#16A34A', '#4ADE80', '#DCFCE7'],
  },
  {
    // Deep navy — Champions League nights
    id: 'ocean',
    bg: '#EFF3FB',
    bgWarm: '#E2E9F6',
    surface: '#F5F7FC',
  ...
  },
  {
    ...
    accent: '#B45309',
    swatch: ['#D97706', '#FBBF24', '#FEF3C7'],
  },
  {
    // Electric purple — freestyle, skills, flair
    id: 'lavender',
    bg: '#F4F0FC',
    bgWarm: '#EBE4F9',
    surface: '#F9F7FD',
    borderTint: 'rgba(109, 40, 217, 0.09)',
    surfaceHover: '#F2EEF9',
    surfaceActive: 'rgba(109, 40, 217, 0.05)',
    headerBg: 'rgba(244, 240, 252, 0.90)',
    navBg: 'rgba(249, 247, 253, 0.93)',
    choiceBg: '#F9F7FD',
    choiceBorder: 'rgba(109, 40, 217, 0.12)',
    accent: '#6D28D9',
    swatch: ['#7C3AED', '#A78BFA', '#EDE9FE'],
  },
  {
    // Terracotta — clay pitch, South American vibes
    id: 'sand',
    bg: '#FBF6F1',
    bgWarm: '#F6EDE2',
    surface: '#FDFAF7',
    borderTint: 'rgba(154, 52, 18, 0.08)',
    surfaceHover: '#F8F3EE',
    surfaceActive: 'rgba(154, 52, 18, 0.05)',
    headerBg: 'rgba(251, 246, 241, 0.90)',
    navBg: 'rgba(253, 250, 247, 0.93)',
    choiceBg: '#FDFAF7',
    choiceBorder: 'rgba(154, 52, 18, 0.10)',
    accent: '#9A3412',
    swatch: ['#C2410C', '#FB923C', '#FFEDD5'],
  },
  {
    // Bold crimson — derby day, passion
    id: 'rose',
    bg: '#FDF0F3',
    bgWarm: '#FAE2E8',
    surface: '#FEF6F8',
